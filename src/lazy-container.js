(function(){
    ...
    angular.module('lazycontainer', [])

        .service('LazyContainer', [function(){
        ...
        .directive('lazyContainer', ['ChoiceParser', '$compile', 'LazyContainer', function(ChoiceParser, $compile, LazyContainer){
        	return {
        		restrict    : 'AE',
        		templateUrl : 'templates/lazy-container.tpl.html',
        		transclude  : true,
        		replace     : true,
